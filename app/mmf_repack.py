...
from app.release_images import command, listing, safe_component, member_path, split_input_aliases, extract_mapped_member, ExtractionError, RESERVE
...
def repack(source,work,identity,progress=lambda *args:None,stopped=lambda:False,*,volume_bytes=VOLUME_BYTES,compression_level=COMPRESSION_LEVEL,sources=None,release_name=None):
    ...
    with tempfile.TemporaryDirectory(prefix='repack-',dir=work) as temporary:
        ...
        from app.mmf_pdf import clean_pdf
