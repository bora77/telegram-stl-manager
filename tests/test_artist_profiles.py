...
from app.artist_profiles import ArtistProfiles, artist_key, image_bytes
...
class LinkTests(unittest.TestCase):
    def module(self):
        spec=importlib.util.spec_from_file_location('collector',Path(__file__).resolve().parent.parent/'tools/collect-artist-profiles.py')
