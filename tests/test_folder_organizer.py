...
from app.folder_organizer import inventory, match_files, Organizer, scan_plan
    ...
    def test_scan_uses_one_exact_cli_listing_without_changing_history(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            class UI:
                ...
                def close(self):pass
            ui=UI()
            with patch('app.folder_organizer.TelegramCLI',return_value=ui):scan_plan(store,'test')
