...
from app.mmf_images import Gallery, image_url, fetch_images
...
class ImagesTests(unittest.TestCase):
    ...
    def test_download_validates_image_and_deduplicates_objects(self):
        ...
        with tempfile.TemporaryDirectory() as d,patch('app.mmf_images.urllib.request.build_opener') as opener:
