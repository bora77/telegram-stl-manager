...
from app.telegram_cli import TelegramCLI, CLIError
from tests.test_support import TEST_SOURCE, configure_source
...
class SourceScopeTests(unittest.TestCase):
    ...
    def test_packager_detects_private_name_across_line_breaks_and_id(self):
        path = Path(__file__).resolve().parent.parent / 'tools/package-release.py'
