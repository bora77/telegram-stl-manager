...
from app.telegram_ui import TelegramUI, UIError, attachment_name_matches, attachment_link
...
class AttachmentTests(unittest.TestCase):
    ...
    @patch('app.telegram_ui.time.sleep')
    ...
    @patch('app.telegram_ui.time.monotonic',side_effect=[0,7])
